...
// The hand-written head of the statement ends at ?22; the extras follow it.
// (?22 is `profile_id`, added by migration 008's reader pass — bump this and
// the head's own numbering together or the binds silently shift.)
const BASE_PARAMS = 22;
    ...
    statements.push(
      env.DB.prepare(`
        ...
        ON CONFLICT(id) DO UPDATE SET
          ...
          -- already have; take the stronger grade but never touch contacts,
          -- notes or stage, which a human may have edited.
      ...
      `).bind(
        ...
        c.land || "", c.note || "", c.job_url || "", c.job_title || "",
        ...
        // ?22. Absent from the ON CONFLICT list on purpose: a re-scrape may
